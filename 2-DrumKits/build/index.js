...
let tinkSound;
let tomSound;
const btnRecordChannel = document.querySelectorAll(".recordChannel button");
const btnPlayChannel = document.querySelectorAll(".playchannel button");
const btnTimer1 = document.querySelector(".timer1");
const btnTimer2 = document.querySelector(".timer2");
const btnTimer3 = document.querySelector(".timer3");
const channel1 = [];
const channel2 = [];
const channel3 = [];
const channel4 = [];
